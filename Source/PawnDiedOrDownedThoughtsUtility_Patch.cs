...
namespace RimThreaded
{
    ...
    {
        [ThreadStatic] public static List<IndividualThoughtToAdd> tmpIndividualThoughtsToAdd;
        [ThreadStatic] public static List<ThoughtToAddToAll> tmpAllColonistsThoughts;
