...
namespace RimThreaded
{
    ...
    public class RimThreadedHarmony
    {
        ...
        private static void AddAdditionalReplacements()
        {
            ...
            replaceFields.Add(Method(typeof(RenderTexture), nameof(RenderTexture_Patch.ReleaseTemporary), new Type[] { typeof(RenderTexture) }), Method(typeof(RenderTexture_Patch), nameof(RenderTexture_Patch.ReleaseTemporary)));
        }
