...
namespace RimThreaded
{
    class Archive_Patch
    {
        ...
        public static bool ExposeData(Archive __instance)
        {
            ...
            {
                Scribe_Collections.Look<IArchivable>(ref __instance.archivables, "archivables", LookMode.Deep, (object[])Array.Empty<object>());
                Scribe_Collections.Look<IArchivable>(ref __instance.pinnedArchivables, "pinnedArchivables", LookMode.Reference);
                if (Scribe.mode != LoadSaveMode.PostLoadInit)
                    return false;
                __instance.archivables.RemoveAll((Predicate<IArchivable>)(x => x == null));
                __instance.pinnedArchivables.RemoveWhere((Predicate<IArchivable>)(x => x == null));
                return false;
            }
        }
